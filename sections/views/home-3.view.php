<div class="tas_home_3 uk-container uk-margin-small-top uk-margin-medium-bottom">
    ...
    <div class="uk-grid-small" uk-grid uk-grid-match>
        ...
        <div class="uk-width-1-4@m uk-visible@s">
            <div class="menu uk-card uk-card-default uk-border-rounded uk-flex uk-flex-column uk-flex-between" style="padding: 20px; background: #fff; box-shadow: 0 5px 15px rgba(0,0,0,0.05); border: 1px solid #e5e5e5; height: 100%; box-sizing: border-box;">
                <div class="uk-flex-1">
                    <?php foreach(array_slice($menuCategories, 0, 4) as $item): ?>
                        <div class="uk-margin-small-bottom">
                            <a href="<?php echo $urlPath->search(['category' => $item['category_slug']]); ?>" class="cat-link uk-flex uk-flex-middle" style="font-size: 0.95rem; padding: 12px 15px; color: #333; text-decoration: none; border-radius: 8px; transition: all 0.3s ease;">
                                <i class="<?php echo getIcon($item['category_icon']); ?> icon" style="font-size: 1.25rem; margin-right: 15px; color: var(--uk-primary-color); width: 24px; text-align: center;"></i>
                ...
                <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #eee;">
                    <a href="<?php echo $urlPath->categories(); ?>" class="cat-link all-cats uk-flex uk-flex-middle" style="font-size: 0.95rem; padding: 12px 15px; color: var(--uk-primary-color); font-weight: 600; text-decoration: none; border-radius: 8px; transition: all 0.3s ease;">
                        <i class="ti ti-apps icon" style="font-size: 1.25rem; margin-right: 15px; width: 24px; text-align: center;"></i>
        ...
        <div class="uk-width-expand@s">
            <div class="uk-position-relative uk-visible-toggle uk-light uk-border-rounded uk-overflow-hidden shadow-sm" tabindex="-1" uk-slideshow="animation: fade; autoplay: true; ratio: false;">
