            ...
            <div>
                <div class="uk-card uk-card-default uk-card-body uk-box-shadow-hover-large uk-border-rounded uk-text-center uk-transition-toggle" tabindex="0">
                    <div class="uk-position-top-center uk-margin-small-top">
                        <span class="uk-badge uk-padding-small" style="background: var(--primary-color); position: absolute; top: -15px; left: 50%; transform: translateX(-50%); font-size: 1.2rem; height: 35px; min-width: 35px; border-radius: 50%;">1</span>
                    </div>
