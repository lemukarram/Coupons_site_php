    ...
    <div class="uk-container">
        <div class="cat-banner-grid">
            <div class="cat-banner-img">
                <img src="<?php echo $urlPath->image($category['category_image']); ?>" alt="<?php echo echoOutput($category['category_title']); ?>">
            </div>
            <div class="cat-banner-content">
                <div class="breadcrumb">
                    ...
                    <span><?php echo echoOutput($category['category_title']); ?></span>
                </div>
                <h1><?php echo echoOutput($category['category_title']); ?></h1>
                <div class="description">
                    <?php echo echoOutput($category['category_description']); ?>
                </div>
                ...
                <div class="related-cats">
                    ...
                    <div class="cat-tags">
                        ...
                        <a href="<?php echo $urlPath->search(['category' => $category['category_slug'], 'subcategory' => $sub['subcategory_slug']]); ?>" class="cat-tag">
    ...
    <div class="uk-grid-large" uk-grid>
        ...
        <div class="uk-width-1-1 uk-width-expand@m content">
                ...
                <div class="feat-stores-grid">
                    ...
                    <a href="<?php echo $urlPath->store($st['store_slug']); ?>" class="feat-store-item">
                        <div class="feat-store-logo">
                            <img src="<?php echo $urlPath->image($st['store_image']); ?>" alt="<?php echo echoOutput($st['store_title']); ?>">
                        </div>
            ...
            <div class="uk-margin-medium-top">
                <h3 class="uk-text-bold uk-margin-bottom"><?php echo echoOutput($category['category_title']); ?> <?php echo echoOutput($translation['tr_16'] ?? 'vouchers'); ?> for <?php echo date('F Y'); ?></h3>
