...
<div class="uk-slider-container">
    ...
    <?php foreach($featuredStores as $item): ?>
        <li>
            ...
            <div class="card">
            <div class="cover" style="background: url(<?php echo $urlPath->image($item['store_image']); ?>)">
            </div>
            <h5 class="card-title uk-text-truncate"><?php echo echoOutput($item['store_title']); ?></h5>
            </div>
            </a>
        </li>
    <?php endforeach; ?>
